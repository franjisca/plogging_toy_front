      ...
      <div className="footer-content">
        ...
        <div className="footer-content-column">
          ...
          <div className="footer-call-to-action">
            ...
            <p className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="tel:0124-64XXXX" target="_self"> hanj1yeon@naver.com </a></p>
          </div>
        </div>
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-wrapper">
          <p className="footer-copyright-text">
            <a className="footer-copyright-link" href="#" target="_self"> ©2023. | Made by J1yeon. | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
